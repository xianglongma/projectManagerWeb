export default {
  ...
  'form.basic-form.basic.description':
    '请输入项目信息，创建项目可以增加个人积分哦',
  'form.basic-form.title.label': '项目名称',
  'form.basic-form.title.placeholder': '给项目起个名字',
  ...
  'form.basic-form.public.label': '项目可见范围',
  'form.basic-form.label.help': '客户、邀评人默认被分享',
  'form.basic-form.radio.public': '全部可见',
  'form.basic-form.radio.partially-public': '项目成员可见',
  'form.basic-form.radio.private': '不可见',
